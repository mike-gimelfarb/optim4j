...
/**
 * Loshchilov, Ilya. "LM-CMA: An alternative to L-BFGS for large-scale black box
 * optimization." Evolutionary computation 25.1 (2017): 143-171.
 * 
 * Loshchilov, Ilya. "A computationally efficient limited memory CMA-ES for
